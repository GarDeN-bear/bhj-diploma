...
class App {
  ...
  static initWidgets() {
    this.widgets = {
      ...
      transactions:
          new TransactionsWidget(document.querySelector('.transactions-panel')),
  ...
  static initForms() {
    ...
    this.forms = {
      ...
      createAccount:
          new CreateAccountForm(document.querySelector('#new-account-form')),
      createIncome:
          new CreateTransactionForm(document.querySelector('#new-income-form')),
